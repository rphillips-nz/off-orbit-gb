...
extern const uint8_t random_sides[RANDOM_SIDES_COUNT];
extern const uint8_t random_flips[RANDOM_FLIPS_COUNT];
extern const int8_t random_velocities[RANDOM_VELOCITIES_COUNT];
extern const int8_t random_positive_velocities[RANDOM_VELOCITIES_COUNT];
extern const int8_t random_negative_velocities[RANDOM_VELOCITIES_COUNT];
extern const uint8_t random_world_x[RANDOM_WORLD_X_COUNT];
extern const uint8_t random_world_y[RANDOM_WORLD_Y_COUNT];

extern uint8_t random_sides_index;
extern uint8_t random_flips_index;
extern uint8_t random_velocities_index;
extern uint8_t random_positive_velocities_index;
extern uint8_t random_negative_velocities_index;
extern uint8_t random_world_x_index;
extern uint8_t random_world_y_index;
